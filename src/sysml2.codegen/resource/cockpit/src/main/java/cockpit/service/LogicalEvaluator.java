...
import «pkg».cockpit.model.monitor.ScalarFunction;
import «pkg».cockpit.model.monitor.PathFieldMapping;
import «pkg».cockpit.model.monitor.VectorFunction;
import «pkg».cockpit.model.monitor.logic.*;
import «pkg».cockpit.model.monitor.predefined.DataType;
import «pkg».cockpit.model.monitor.predefined.PrimitiveType;
